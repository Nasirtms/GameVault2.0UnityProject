...
public class StickyPiggySoundManager : MonoBehaviour
{
    #region variables

    public static StickyPiggySoundManager Instance;

    [SerializeField] private StickyPiggyGameSettings soundData;
