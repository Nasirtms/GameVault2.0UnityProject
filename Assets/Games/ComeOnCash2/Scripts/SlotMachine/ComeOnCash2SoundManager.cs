...
public class ComeOnCash2SoundManager : MonoBehaviour
{
    #region Variables
    public static ComeOnCash2SoundManager Instance;

    [SerializeField] private ComeOnCash2GameSettings soundData;
