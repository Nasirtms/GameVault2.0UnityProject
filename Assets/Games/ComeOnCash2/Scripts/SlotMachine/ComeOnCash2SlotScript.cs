...
public class ComeOnCash2SlotScript : MonoBehaviour
{
    #region Variables
    ...
    // Slot Details
    private int index;
    [HideInInspector] public ComeOnCash2SlotType type;
    public ComeOnCash2SlotResource currentResource;
    [HideInInspector] public bool isResultSet = false;

    // Components
    private Image icon;
    private Image paylineIcon;
    private ComeOnCash2ReelScript _parent;
    ...
    public void Initialize(ComeOnCash2ReelScript parentReel, int index)
    {
        this.index = index;
    ...
    public void SetType(ComeOnCash2SlotResource newType)
    {
    ...
    {
        var random = ComeOnCash2SlotMachine.CachedRealSymbols[
            Random.Range(0, ComeOnCash2SlotMachine.CachedRealSymbols.Count)];
        SetType(random);
    }
    ...
    {
        if(type == ComeOnCash2SlotType.Blank)
        {
            return;
        }
