...
[RequireComponent(typeof(ComeOnCash2BetController))]
[RequireComponent(typeof(ComeOnCash2RulesPopupController))]
[RequireComponent(typeof(ComeOnCash2AutoSpinController))]
public class ComeOnCash2UIManager : GameBetServices
{
    #region Variables

    public static ComeOnCash2UIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public ComeOnCash2UIButtonController spinButton;
    [SerializeField] private ComeOnCash2UIButtonController stopButton;
    ...
    // Scripts
    public ComeOnCash2BetController betController;
    private ComeOnCash2RulesPopupController rulesPopupController;
    private ComeOnCash2AutoSpinController autoSpinController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<ComeOnCash2BetController>();
        rulesPopupController = GetComponent<ComeOnCash2RulesPopupController>();
        autoSpinController = GetComponent<ComeOnCash2AutoSpinController>();
    ...
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsSoundMute())
            ComeOnCash2SoundManager.Instance.PlaySFX(soundName);
    }

    public void PlayMusic(string soundName)
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsMusicMute())
            ComeOnCash2SoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsMusicMute())
            ComeOnCash2SoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsSoundMute())
            ComeOnCash2SoundManager.Instance.PlaySpinMusic(soundName);
    }
    public void StopSpinMusic(string soundName)
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsSoundMute())
            ComeOnCash2SoundManager.Instance.StopSpinMusic(soundName);
    }
    private void PlayWinMusic(string soundName)
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsSoundMute())
            ComeOnCash2SoundManager.Instance.PlayWinMusic(soundName);
    }
    ...
    private void StopWinMusic(string soundName)
    {
        if (soundName == null || ComeOnCash2SoundManager.Instance == null) return;
        if (!ComeOnCash2SoundManager.Instance.IsSoundMute())
            ComeOnCash2SoundManager.Instance.StopWinMusic(soundName);
    }
    public void SoundActive(bool soundActive)
    {
        ComeOnCash2SoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        ComeOnCash2SoundManager.Instance.MuteMusic(!musicActive);
    ...
    {
        if(ComeOnCash2SlotMachine.Instance.isFreeGameReady) return;
        PlaySpinMusic("Spin");
    ...
    private void OnClickStop()
    {
        ...
        ComeOnCash2SlotMachine.Instance.isStopBtnPressed = true;
        ComeOnCash2SlotMachine.Instance.StopWithResult();
        
        if (ComeOnCash2AutoSpinController.isAutoSpinning)
        {
