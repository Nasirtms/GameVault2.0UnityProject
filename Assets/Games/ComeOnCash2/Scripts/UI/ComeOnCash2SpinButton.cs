...
public class ComeOnCash2SpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        ComeOnCash2UIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        ComeOnCash2UIManager.Instance.OnHoldSpin();
    }
