...
public class BuffaloXtraReelPowerSoundManager : MonoBehaviour
{
    #region variables

    public static BuffaloXtraReelPowerSoundManager Instance;

    [SerializeField] private BuffaloXtraReelPowerGameSettings soundData;
