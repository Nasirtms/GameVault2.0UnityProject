...
[RequireComponent(typeof(BuffaloXtraReelPowerBetController))]
[RequireComponent(typeof(BuffaloXtraReelPowerAutoSpinController))]
[RequireComponent(typeof(BuffaloXtraReelPowerRulesPopupController))]
public class BuffaloXtraReelPowerUIManager : GameBetServices
{
    #region Variables

    public static BuffaloXtraReelPowerUIManager Instance;
    ...
    private BuffaloXtraReelPowerBetController betController;
    private BuffaloXtraReelPowerAutoSpinController autoSpinController;
    private BuffaloXtraReelPowerRulesPopupController rulesPopupController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<BuffaloXtraReelPowerBetController>();
        autoSpinController = GetComponent<BuffaloXtraReelPowerAutoSpinController>();
        rulesPopupController = GetComponent<BuffaloXtraReelPowerRulesPopupController>();
    ...
    public void PlaySound(string soundName)
    {
        ...
        if (!BuffaloXtraReelPowerSoundManager.Instance.IsSoundMute())
            BuffaloXtraReelPowerSoundManager.Instance.PlaySFX(soundName);
    }

    public void StopCurrentSFX()
    {
        if (!BuffaloXtraReelPowerSoundManager.Instance.IsSoundMute())
            BuffaloXtraReelPowerSoundManager.Instance.StopSFX();
    }
    ...
    public void PlayMusic(string soundName)
    {
        ...
        if (!BuffaloXtraReelPowerSoundManager.Instance.IsMusicMute())
            BuffaloXtraReelPowerSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        ...
        if (!BuffaloXtraReelPowerSoundManager.Instance.IsMusicMute())
            BuffaloXtraReelPowerSoundManager.Instance.StopMusic(soundName);
    }
    ...
    public void PlaySpinMusic(string soundName)
    {
        ...
        if (!BuffaloXtraReelPowerSoundManager.Instance.IsSoundMute())
            BuffaloXtraReelPowerSoundManager.Instance.SpinPlayMusic(soundName);
    }
    ...
    public void StopSpinMusic(string soundName)
    {
        ...
        if (!BuffaloXtraReelPowerSoundManager.Instance.IsSoundMute())
            BuffaloXtraReelPowerSoundManager.Instance.SpinStopMusic(soundName);
    }

    private void SoundActive(bool soundActive)
    {
        BuffaloXtraReelPowerSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        BuffaloXtraReelPowerSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        ...
        if (BuffaloXtraReelPowerAutoSpinController.isAutoSpinning)
        {
