...
public class CleopatraSoundManager : MonoBehaviour
{
    [SerializeField] private CleopatraGameSettings soundData;
    ...
    private static CleopatraSoundManager instance;
    public static CleopatraSoundManager Instance => instance;
