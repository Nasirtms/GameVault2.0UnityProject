...
public class FruitSlotBetController : MonoBehaviour
{
    ...
    public delegate void FruitSlotBetControllerEvents();
    public static event FruitSlotBetControllerEvents OnBetValueChanged;
