...
public class LifeOfLuxurySoundManager : MonoBehaviour
{
    #region variables

    public static LifeOfLuxurySoundManager Instance;

    [SerializeField] private LifeOfLuxuryGameSettings soundData;
