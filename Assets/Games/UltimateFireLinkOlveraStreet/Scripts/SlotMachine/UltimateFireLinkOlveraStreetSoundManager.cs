...
public class UltimateFireLinkOlveraStreetSoundManager : MonoBehaviour
{
    #region variables

    public static UltimateFireLinkOlveraStreetSoundManager Instance;

    [SerializeField] private UltimateFireLinkOlveraStreetGameSettings soundData;
