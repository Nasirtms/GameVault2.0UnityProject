...
public class UltimateFireLinkOlveraStreetFreeGameTransitionController : MonoBehaviour
{
    public static UltimateFireLinkOlveraStreetFreeGameTransitionController Instance { get; private set; }
    ...
    private UltimateFireLinkOlveraStreetFreeSpinController freeSpinController;
    private void Awake()
    {
        Instance = this;
    }
    ...
    private void Start()
    {
        freeSpinController = GetComponent<UltimateFireLinkOlveraStreetFreeSpinController>();
    ...
    public IEnumerator StratFreeSpinTransition()
    {
        ...
        int x = UltimateFireLinkOlveraStreetSlotMachine.Instance.freeSpinCount;
        ...
        UltimateFireLinkOlveraStreetUIManager.Instance.UpdateButtons("FreeSpin");
    ...
    public void OnClickFreeSpinStart()
    {
        ...
        UltimateFireLinkOlveraStreetUIManager.Instance.PlayMusic("FreeSpinBG");
    }
    ...
    private IEnumerator EndFreeSpinTransition()
    {
        ...
        freeSpinWin.text = UltimateFireLinkOlveraStreetSlotMachine.Instance.freeSpinWinAmount.ToString("F2");
        float finalAmount = UltimateFireLinkOlveraStreetSlotMachine.Instance.freeSpinWinAmount;
        if (finalAmount > 0)
        {
    ...
    private void WinAnimation(float freegamewin)
    {
        if (freegamewin > 0)
        {
            ...
            GameBetServices.Instance.PlayWinAnimation(betAmount, freegamewin, UltimateFireLinkOlveraStreetSlotMachine.Instance.currentSpinResult.newBalance);
