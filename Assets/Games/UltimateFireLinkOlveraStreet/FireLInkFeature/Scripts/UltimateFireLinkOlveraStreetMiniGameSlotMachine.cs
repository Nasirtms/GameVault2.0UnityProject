...
public class UltimateFireLinkOlveraStreetMiniGameSlotMachine : MonoBehaviour
{
    #region Variables
    public static UltimateFireLinkOlveraStreetMiniGameSlotMachine Instance;

    [Header("Machine References")]
    public UltimateFireLinkOlveraStreetMiniGameSettings settings;
    public List<UltimateFireLinkOlveraStreetMiniGameReelScript> reels;
    [ShowInInspector][ReadOnly] public UltimateFireLinkOlveraStreetSpinResult currentSpinResult;
    ...
    {
        if (result is UltimateFireLinkOlveraStreetSpinResult normalSpin)
        {
    ...
    public IEnumerator StartSpin()
    {
        ...
        if (!UltimateFireLinkOlveraStreetSlotMachine.Instance.isMiniGame || firstReSpin)
        {
            UltimateFireLinkOlveraStreetSlotMachine.Instance.isMiniGameReady = false;
        }
    ...
    private IEnumerator WaitUntilResultAndThenStop()
    {
        ...
        if (currentSpinResult == null || currentSpinResult.reels == null || currentSpinResult.reels.Count == 0)
        {
            ...
            UltimateFireLinkRiverWalkUIManager.Instance.UpdateButtons("Stop");
    ...
    public void Stop()
    {
        ...
        if (currentSpinResult == null || currentSpinResult.reels == null || currentSpinResult.reels.Count == 0)
        {
            ...
            if (!UltimateFireLinkOlveraStreetSlotMachine.Instance.isMiniGame)
            {
                UltimateFireLinkOlveraStreetUIManager.Instance.UpdateButtons("Stop");
            }
            return;
        }
    ...
    private IEnumerator StopReelsWithResultRoutine()
    {
        ...
        if (settings.spinSettings.endSpin == UltimateFireLinkOlveraStreetMiniGameSpinMode.SpinAll)
        {
    ...
    //    }
    //}
    private void SetReelDirection(UltimateFireLinkOlveraStreetMiniGameReelScript reel)
    {
        UltimateFireLinkOlveraStreetMiniGameSpinDirection direction = settings.spinSettings.spinDirection;

        // If random direction, choose randomly for each reel
        if (direction == UltimateFireLinkOlveraStreetMiniGameSpinDirection.Random)
        {
            direction = Random.value > 0.5f ? UltimateFireLinkOlveraStreetMiniGameSpinDirection.Up : UltimateFireLinkOlveraStreetMiniGameSpinDirection.Down;
        }
    ...
    //    }
    //}
    public static UltimateFireLinkOlveraStreetMiniGameSlotResource? GetResourceById(string id)
    {
    ...
    public bool isSphereSlot(UltimateFireLinkOlveraStreetMiniGameSlotType slotType)
    {
        if (slotType == UltimateFireLinkOlveraStreetMiniGameSlotType.Mini)
        {
            return true;
        }
