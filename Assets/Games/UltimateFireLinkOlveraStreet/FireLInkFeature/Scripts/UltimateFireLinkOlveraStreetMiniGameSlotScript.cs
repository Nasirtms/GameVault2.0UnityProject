...
public class UltimateFireLinkOlveraStreetMiniGameSlotScript : MonoBehaviour
{
    #region Variables

    // Slot Resource
    [HideInInspector] public UltimateFireLinkOlveraStreetMiniGameSlotType slotType;
    [HideInInspector] public UltimateFireLinkOlveraStreetMiniGameSlotResource currentResource;
    ...
    {
        var random = UltimateFireLinkOlveraStreetMiniGameSlotMachine.Instance.settings.slotResources[UnityEngine.Random.Range(0, UltimateFireLinkOlveraStreetMiniGameSlotMachine.Instance.settings.slotResources.Count)];
        SetType(random, false);
    }
    public void SetType(UltimateFireLinkOlveraStreetMiniGameSlotResource newType, bool finalResult)
    {
        ...
        if (slotType == UltimateFireLinkOlveraStreetMiniGameSlotType.Mini)
        {
            ...
            else
            {
                ...
                float bet = UltimateFireLinkOlveraStreetSlotMachine.Instance.CurrentBet();
    ...
    {
        var targetbox = UltimateFireLinkOlveraStreetMiniGameManager.Instance.Target_Text;
        ...
        UltimateFireLinkOlveraStreetMiniGameManager.Instance.Target_Text.text = $"${WinCollectedAmount.ToString("F2")}";
