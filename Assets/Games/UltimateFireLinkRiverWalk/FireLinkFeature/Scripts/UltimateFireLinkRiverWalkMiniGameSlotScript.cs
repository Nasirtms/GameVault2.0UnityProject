...
public class UltimateFireLinkRiverWalkMiniGameSlotScript : MonoBehaviour
{
    #region Variables

    // Slot Resource
    [HideInInspector] public UltimateFireLinkRiverWalkMiniGameSlotType slotType;
    [HideInInspector] public UltimateFireLinkRiverWalkMiniGameSlotResource currentResource;
    ...
    {
        var random = UltimateFireLinkRiverWalkMiniGameSlotMachine.Instance.settings.slotResources[UnityEngine.Random.Range(0, UltimateFireLinkRiverWalkMiniGameSlotMachine.Instance.settings.slotResources.Count)];
        SetType(random, false);
    }
    public void SetType(UltimateFireLinkRiverWalkMiniGameSlotResource newType, bool finalResult)
    {
        ...
        if (slotType == UltimateFireLinkRiverWalkMiniGameSlotType.Mini)
        {
            ...
            else
            {
                ...
                float bet = UltimateFireLinkRiverWalkSlotMachine.Instance.CurrentBet();
    ...
    {
        var targetbox = UltimateFireLinkRiverWalkMiniGameManager.Instance.Target_Text;
        ...
        UltimateFireLinkRiverWalkMiniGameManager.Instance.Target_Text.text = $"${WinCollectedAmount.ToString("F2")}";
