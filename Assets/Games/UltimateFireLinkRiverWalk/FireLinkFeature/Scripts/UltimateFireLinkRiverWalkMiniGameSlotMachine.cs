...
public class UltimateFireLinkRiverWalkMiniGameSlotMachine : MonoBehaviour
{
    #region Variables
    public static UltimateFireLinkRiverWalkMiniGameSlotMachine Instance;
    ...
    public IEnumerator StartSpin()
    {
        ...
        if (!UltimateFireLinkRiverWalkSlotMachine.Instance.isMiniGame || firstReSpin)
        {
            UltimateFireLinkRiverWalkSlotMachine.Instance.isMiniGameReady = false;
        }
    ...
    public void Stop()
    {
        ...
        if (currentSpinResult == null || currentSpinResult.reels == null || currentSpinResult.reels.Count == 0)
        {
            ...
            if (!UltimateFireLinkRiverWalkSlotMachine.Instance.isMiniGame)
            {
                UltimateFireLinkRiverWalkUIManager.Instance.UpdateButtons("Stop");
            }
            return;
    ...
    private IEnumerator StopReelsWithResultRoutine()
    {
        ...
        if (settings.spinSettings.endSpin == UltimateFireLinkRiverWalkMiniGameSpinMode.SpinAll)
        {
    ...
    //    }
    //}
    private void SetReelDirection(UltimateFireLinkRiverWalkMiniGameReelScript reel)
    {
        UltimateFireLinkRiverWalkMiniGameSpinDirection direction = settings.spinSettings.spinDirection;

        // If random direction, choose randomly for each reel
        if (direction == UltimateFireLinkRiverWalkMiniGameSpinDirection.Random)
        {
            direction = Random.value > 0.5f ? UltimateFireLinkRiverWalkMiniGameSpinDirection.Up : UltimateFireLinkRiverWalkMiniGameSpinDirection.Down;
        }
    ...
    //    }
    //}
    public static UltimateFireLinkRiverWalkMiniGameSlotResource? GetResourceById(string id)
    {
    ...
    public bool isSphereSlot(UltimateFireLinkRiverWalkMiniGameSlotType slotType)
    {
        if (slotType == UltimateFireLinkRiverWalkMiniGameSlotType.Mini)
        {
            return true;
        }
