...
public class UltimateFireLinkRiverWalkSoundManager : MonoBehaviour
{
    #region variables

    public static UltimateFireLinkRiverWalkSoundManager Instance;

    [SerializeField] private UltimateFireLinkRiverWalkGameSettings soundData;
