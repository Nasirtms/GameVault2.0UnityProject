...
[RequireComponent(typeof(UltimateFireLinkRiverWalkBetController))]
[RequireComponent(typeof(UltimateFireLinkRiverWalkRulesPopupController))]
[RequireComponent(typeof(UltimateFireLinkRiverWalkAutoSpinController))]
public class UltimateFireLinkRiverWalkUIManager : GameBetServices
{
    #region Variables

    public static UltimateFireLinkRiverWalkUIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public UltimateFireLinkRiverWalkUIButtonController spinButton;
    [SerializeField] public UltimateFireLinkRiverWalkUIButtonController stopButton;
    [SerializeField] public UltimateFireLinkRiverWalkUIButtonController autoButton;
    [SerializeField] public UltimateFireLinkRiverWalkUIButtonController autoStopButton;
    ...
    private UltimateFireLinkRiverWalkBetController betController;
    private UltimateFireLinkRiverWalkRulesPopupController rulesPopupController;
    private UltimateFireLinkRiverWalkAutoSpinController autoSpinController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<UltimateFireLinkRiverWalkBetController>();
        rulesPopupController = GetComponent<UltimateFireLinkRiverWalkRulesPopupController>();
        autoSpinController = GetComponent<UltimateFireLinkRiverWalkAutoSpinController>();
    ...
    public void PlaySound(string soundName)
    {
        ...
        if (!UltimateFireLinkRiverWalkSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRiverWalkSoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!UltimateFireLinkRiverWalkSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRiverWalkSoundManager.Instance.StopSFX();
    }
    public void PlayMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRiverWalkSoundManager.Instance.IsMusicMute())
            UltimateFireLinkRiverWalkSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRiverWalkSoundManager.Instance.IsMusicMute())
            UltimateFireLinkRiverWalkSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRiverWalkSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRiverWalkSoundManager.Instance.SpinPlayMusic(soundName);
    }
    ...
    public void StopSpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRiverWalkSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRiverWalkSoundManager.Instance.SpinStopMusic(soundName);
    }
    ...
    {
        UltimateFireLinkRiverWalkSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        UltimateFireLinkRiverWalkSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        PlaySound("Button");
        StopSpinMusic("Spin");
        UltimateFireLinkRiverWalkSlotMachine.Instance.isStopBtnPressed = true;
        UltimateFireLinkRiverWalkSlotMachine.Instance.StopWithResult();
    }

    private void OnClickAuto()
    {
        if (autoSpinController == null) return;
        autoButton.setInteractable(!UltimateFireLinkRiverWalkSlotMachine.Instance.InSpin);
    ...
    private void OnClickAutoStop()
    {
        ...
        if (!UltimateFireLinkRiverWalkSlotMachine.Instance.InSpin)
        {
            UpdateButtons("Idle");
        }
    }
    ...
    private IEnumerator WinAnimation(GameObject winType, TMP_Text winText, float targetAmount, int animatorIndex, string animationTrigger)
    {
        ...
        if (UltimateFireLinkRiverWalkSlotMachine.Instance.isFreeGameReady)
        {
