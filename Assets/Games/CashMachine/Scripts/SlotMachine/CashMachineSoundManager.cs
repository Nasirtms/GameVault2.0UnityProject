...
public class CashMachineSoundManager : MonoBehaviour
{
    #region Variables
    public static CashMachineSoundManager Instance;

    [SerializeField] private CashMachineGameSettings soundData;
