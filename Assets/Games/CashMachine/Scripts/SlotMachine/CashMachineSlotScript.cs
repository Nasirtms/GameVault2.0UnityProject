...
public class CashMachineSlotScript : MonoBehaviour
{
    #region Variables
    ...
    // Slot Details
    private int index;
    [HideInInspector] public CashMachineSlotType type;
    public CashMachineSlotResource currentResource;
    [HideInInspector] public bool isResultSet = false;

    // Components
    private Image icon;
    private Image paylineIcon;
    private CashMachineReelScript _parent;
    ...
    public void Initialize(CashMachineReelScript parentReel, int index)
    {
        this.index = index;
    ...
    public void SetType(CashMachineSlotResource newType)
    {
    ...
    {
        var random = CashMachineSlotMachine.CachedRealSymbols[
            Random.Range(0, CashMachineSlotMachine.CachedRealSymbols.Count)];
        SetType(random);
    }
    ...
    {
        if(type == CashMachineSlotType.Blank)
        {
            return;
        }
