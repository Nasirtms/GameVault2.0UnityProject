...
[RequireComponent(typeof(CashMachineBetController))]
[RequireComponent(typeof(CashMachineRulesPopupController))]
[RequireComponent(typeof(CashMachineAutoSpinController))]
public class CashMachineUIManager : GameBetServices
{
    #region Variables

    public static CashMachineUIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public CashMachineUIButtonController spinButton;
    [SerializeField] private CashMachineUIButtonController stopButton;
    ...
    // Scripts
    public CashMachineBetController betController;
    private CashMachineRulesPopupController rulesPopupController;
    private CashMachineAutoSpinController autoSpinController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<CashMachineBetController>();
        rulesPopupController = GetComponent<CashMachineRulesPopupController>();
        autoSpinController = GetComponent<CashMachineAutoSpinController>();
    ...
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsSoundMute())
            CashMachineSoundManager.Instance.PlaySFX(soundName);
    }

    public void PlayMusic(string soundName)
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsMusicMute())
            CashMachineSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsMusicMute())
            CashMachineSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsSoundMute())
            CashMachineSoundManager.Instance.PlaySpinMusic(soundName);
    }
    public void StopSpinMusic(string soundName)
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsSoundMute())
            CashMachineSoundManager.Instance.StopSpinMusic(soundName);
    }
    private void PlayWinMusic(string soundName)
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsSoundMute())
            CashMachineSoundManager.Instance.PlayWinMusic(soundName);
    }
    ...
    private void StopWinMusic(string soundName)
    {
        if (soundName == null || CashMachineSoundManager.Instance == null) return;
        if (!CashMachineSoundManager.Instance.IsSoundMute())
            CashMachineSoundManager.Instance.StopWinMusic(soundName);
    }
    public void SoundActive(bool soundActive)
    {
        CashMachineSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        CashMachineSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        ...
        CashMachineSlotMachine.Instance.isStopBtnPressed = true;
        CashMachineSlotMachine.Instance.StopWithResult();
        
        if (CashMachineAutoSpinController.isAutoSpinning)
        {
