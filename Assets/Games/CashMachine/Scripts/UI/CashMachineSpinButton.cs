...
public class CashMachineSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        CashMachineUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        CashMachineUIManager.Instance.OnHoldSpin();
    }
