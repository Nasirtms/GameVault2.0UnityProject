...
public class BiggerBassBonanzaSoundManager : MonoBehaviour
{
    #region Variables

    public static BiggerBassBonanzaSoundManager Instance;

    [SerializeField] private BiggerBassBonanzaGameSettings soundData;
