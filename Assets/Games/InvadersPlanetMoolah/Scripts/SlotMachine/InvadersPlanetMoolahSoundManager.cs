...
public class InvadersPlanetMoolahSoundManager : MonoBehaviour
{
    #region Variables

    public static InvadersPlanetMoolahSoundManager Instance;

    [SerializeField] private InvadersPlanetMoolahGameSettings soundData;
