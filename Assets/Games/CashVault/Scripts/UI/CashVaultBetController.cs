...
public class CashVaultBetController : MonoBehaviour
{
    #region Variables
    ...
    public delegate void CashVaultBetControllerEvents();
    public static event CashVaultBetControllerEvents OnBetValueChanged;
    #endregion
