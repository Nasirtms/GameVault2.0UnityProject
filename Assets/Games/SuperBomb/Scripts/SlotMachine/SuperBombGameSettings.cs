...
[System.Serializable]
public struct SuperBombSlotResource
{
...
public enum SuperBombSpinType
{
    Single, All
}

[System.Serializable]
public class SuperBombSpinSettings
{
    [Title("Reel Spinning")]
    [EnumToggleButtons] public SuperBombSpinType startSpin;
    [EnumToggleButtons] public SuperBombSpinType endSpin;
...
[System.Serializable]
public class SuperBombSoundItem
{
...
[CreateAssetMenu(menuName = "Settings/SuperBomb", fileName = "New_Settings")]
public class SuperBombGameSettings : ScriptableObject
{
    public delegate void SuperBombSettingsEvents();
    public static event SuperBombSettingsEvents UpdateLayout;
    public static event SuperBombSettingsEvents UpdateScale;

    [TabGroup("Resources")]
    [TableList]
    public List<SuperBombSlotResource> resourcesList;

    [TabGroup("Sound")]
    [TableList]
    public List<SuperBombSoundItem> soundItems;

    [TabGroup("Spin Settings")]
    [HideLabel]
    public SuperBombSpinSettings spinSettings;
    ...
    public SuperBombSoundItem GetSound(string soundName)
    {
