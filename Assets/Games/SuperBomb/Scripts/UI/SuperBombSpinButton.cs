...
public class SuperBombSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        SuperBombUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        SuperBombUIManager.Instance.spinButton.SetButtonInteractable(false);
        SuperBombUIManager.Instance.OnClickAuto();
    }
