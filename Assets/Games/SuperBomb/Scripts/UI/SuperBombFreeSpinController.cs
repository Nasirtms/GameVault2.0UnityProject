...
public class SuperBombFreeSpinController : MonoBehaviour
{
    #region Variables
    ...
    private void Start()
    {
        paylinesToPlay = SuperBombPaylineController.Instance.activePaylines.Count;
    }
    ...
    private void EndFreeSpins()
    {
        ...
        SuperBombSlotMachine.Instance.isFreeGame = false;
