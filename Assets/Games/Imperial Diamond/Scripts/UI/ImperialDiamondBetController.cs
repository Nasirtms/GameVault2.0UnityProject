...
public class ImperialDiamondBetController : MonoBehaviour
{
    #region Variables
    ...
    private float[] betValues = new float[] {
        0.10f, 0.50f, 1.00f, 2.00f, 3.00f, 4.00f, 5.00f, 6.00f, 7.00f, 8.00f, 9.00f, 10.00f
    };
    ...
    private void UpdateBetUI()
    {
        ...
        float line = betValues[currentIndex];
