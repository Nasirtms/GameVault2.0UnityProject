...
public class QuickHitVolcanoSoundManager : MonoBehaviour
{
    #region Variables

    public static QuickHitVolcanoSoundManager Instance;

    [SerializeField] private QuickHitVolcanoGameSettings soundData;
