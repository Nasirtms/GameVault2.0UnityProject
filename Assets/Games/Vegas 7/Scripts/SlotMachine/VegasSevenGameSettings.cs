...
public enum VegasSevenSlotType
{
     Empty, Green7, Red7, Blue7, Green77, Green777, RedHot3X, Bonus
}

[System.Serializable]
public struct VegasSevenResource
{
    public VegasSevenSlotType type;
    public string slotAnimationBool;
    public int slotTypeIndex;
}
public enum VegasSevenSpinType
{
    Single, All
}

[System.Serializable]
public struct VegasSevenSlotResource
{
    public VegasSevenSlotType type;
...
[System.Serializable]
public class VegasSevenSpinSettings
{
    [Title("Reel Spinning")]
    [EnumToggleButtons] public VegasSevenSpinType startSpin;
    [EnumToggleButtons] public VegasSevenSpinType endSpin;
...
[System.Serializable]
public class VegasSevenSoundItem
{
...
[CreateAssetMenu(menuName = "Settings/Vegas Seven", fileName = "VegasSeven")]
public class VegasSevenGameSettings : ScriptableObject
{
    public delegate void VegasSevenSettingsEvents();
    public static event VegasSevenSettingsEvents UpdateLayout;
    public static event VegasSevenSettingsEvents UpdateScale;

    [TabGroup("Slot Resources")]
    [TableList]
    public List<VegasSevenResource> resourcesList;

    [TabGroup("Sound")]
    [TableList]
    public List<VegasSevenSoundItem> soundItems;


    [TabGroup("Spin Settings")]
    [HideLabel]
    public VegasSevenSpinSettings spinSettings;
    ...
    public VegasSevenSoundItem GetSound(string soundName)
    {
