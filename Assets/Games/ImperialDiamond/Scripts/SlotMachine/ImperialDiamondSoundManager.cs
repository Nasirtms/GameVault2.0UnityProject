...
public class ImperialDiamondSoundManager : MonoBehaviour
{
    #region Variables
    public static ImperialDiamondSoundManager Instance;

    [SerializeField] private ImperialDiamondGameSettings soundData;
