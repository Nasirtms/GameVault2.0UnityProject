...
public class ImperialDiamondSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        ImperialDiamondUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        ImperialDiamondUIManager.Instance.OnHoldSpin();
    }
