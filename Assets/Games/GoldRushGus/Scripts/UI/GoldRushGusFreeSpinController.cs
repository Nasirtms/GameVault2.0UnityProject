...
using TMPro;
using UnityEngine;
public class GoldRushGusFreeSpinController : MonoBehaviour
{
    #region Variables
    ...
    private IEnumerator FreeSpinLoop()
    {
        ...
        while (freeSpinDone < totalFreeSpins)
        {
            ...
            if (GoldRushGusSlotMachine.Instance.currentSpinResult != null)
            {
    ...
    private void EndFreeSpins()
    {
        ...
        GoldRushGusSlotMachine.Instance.isFreeGame = false;

        GoldRushGusFreeGameTransitionController.Instance.EndFreeSpinTransition();
    }
