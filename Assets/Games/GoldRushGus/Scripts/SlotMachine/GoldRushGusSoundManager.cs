...
public class GoldRushGusSoundManager : MonoBehaviour
{
    #region variables

    public static GoldRushGusSoundManager Instance;

    [SerializeField] private GoldRushGusGameSettings soundData;
