...
public class IrishPotLuckSoundManager : MonoBehaviour
{
    #region variables

    public static IrishPotLuckSoundManager Instance;

    [SerializeField] private IrishPotLuckGameSettings soundData;
