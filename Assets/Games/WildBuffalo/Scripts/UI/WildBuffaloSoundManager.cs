...
public class WildBuffaloSoundManager : MonoBehaviour
{
    #region variables

    public static WildBuffaloSoundManager Instance;

    [SerializeField] private WildBuffaloGameSettings soundData;
