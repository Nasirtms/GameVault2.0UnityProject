...
public class WildBuffaloSlotScript : MonoBehaviour
{
    #region Variables
    ...
    // Slot Resource
    [HideInInspector] public WildBuffaloSlotType slotType;
    [HideInInspector] public WildBuffaloSlotResource currentResource;
    ...
    {
        var random = WildBuffaloSlotMachine.Instance.settings.slotResources[
            UnityEngine.Random.Range(0, WildBuffaloSlotMachine.Instance.settings.slotResources.Count)
        ];

        SetType(random, false);
    }

    public void SetType(WildBuffaloSlotResource newType, bool finalResult)
    {
