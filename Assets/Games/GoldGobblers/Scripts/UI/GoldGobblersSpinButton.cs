...
public class GoldGobblersSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        GoldGobblersUIManager.Instance.OnClickSpin();
    }

    //private void OnLongPress()
    //{
    //    GoldGobblersUIManager.Instance.OnHoldSpin();
    //}
