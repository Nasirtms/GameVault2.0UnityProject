...
public class UltimateFireLinkRueRoyaleSoundManager : MonoBehaviour
{
    #region variables

    public static UltimateFireLinkRueRoyaleSoundManager Instance;

    [SerializeField] private UltimateFireLinkRueRoyaleGameSettings soundData;
