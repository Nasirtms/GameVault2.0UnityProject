...
[RequireComponent(typeof(UltimateFireLinkRueRoyaleBetController))]
[RequireComponent(typeof(UltimateFireLinkRueRoyaleRulesPopupController))]
[RequireComponent(typeof(UltimateFireLinkRueRoyaleAutoSpinController))]
public class UltimateFireLinkRueRoyaleUIManager : GameBetServices
{
    #region Variables

    public static UltimateFireLinkRueRoyaleUIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public UltimateFireLinkRueRoyaleUIButtonController spinButton;
    [SerializeField] public UltimateFireLinkRueRoyaleUIButtonController stopButton;
    [SerializeField] public UltimateFireLinkRueRoyaleUIButtonController autoButton;
    [SerializeField] public UltimateFireLinkRueRoyaleUIButtonController autoStopButton;
    ...
    private UltimateFireLinkRueRoyaleBetController betController;
    private UltimateFireLinkRueRoyaleRulesPopupController rulesPopupController;
    private UltimateFireLinkRueRoyaleAutoSpinController autoSpinController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<UltimateFireLinkRueRoyaleBetController>();
        rulesPopupController = GetComponent<UltimateFireLinkRueRoyaleRulesPopupController>();
        autoSpinController = GetComponent<UltimateFireLinkRueRoyaleAutoSpinController>();
    ...
    public void PlaySound(string soundName)
    {
        ...
        if (!UltimateFireLinkRueRoyaleSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRueRoyaleSoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!UltimateFireLinkRueRoyaleSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRueRoyaleSoundManager.Instance.StopSFX();
    }
    public void PlayMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRueRoyaleSoundManager.Instance.IsMusicMute())
            UltimateFireLinkRueRoyaleSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRueRoyaleSoundManager.Instance.IsMusicMute())
            UltimateFireLinkRueRoyaleSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRueRoyaleSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRueRoyaleSoundManager.Instance.SpinPlayMusic(soundName);
    }
    ...
    public void StopSpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRueRoyaleSoundManager.Instance.IsSoundMute())
            UltimateFireLinkRueRoyaleSoundManager.Instance.SpinStopMusic(soundName);
    }
    ...
    {
        UltimateFireLinkRueRoyaleSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        UltimateFireLinkRueRoyaleSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        PlaySound("Button");
        StopSpinMusic("Spin");
        UltimateFireLinkRueRoyaleSlotMachine.Instance.isStopBtnPressed = true;
        UltimateFireLinkRueRoyaleSlotMachine.Instance.StopWithResult();
    }

    private void OnClickAuto()
    {
        if (autoSpinController == null) return;
        autoButton.setInteractable(!UltimateFireLinkRueRoyaleSlotMachine.Instance.InSpin);
    ...
    private void OnClickAutoStop()
    {
        ...
        if (!UltimateFireLinkRueRoyaleSlotMachine.Instance.InSpin)
        {
            UpdateButtons("Idle");
        }
    }
