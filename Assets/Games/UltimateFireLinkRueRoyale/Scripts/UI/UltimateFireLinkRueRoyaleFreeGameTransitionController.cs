...
public class UltimateFireLinkRueRoyaleFreeGameTransitionController : MonoBehaviour
{
    public static UltimateFireLinkRueRoyaleFreeGameTransitionController Instance { get; private set; }
    ...
    private void WinAnimation(float freegamewin)
    {
        if (freegamewin > 0)
        {
            ...
            GameBetServices.Instance.PlayWinAnimation(betAmount, freegamewin, UltimateFireLinkRueRoyaleSlotMachine.Instance.currentSpinResult.newBalance);
