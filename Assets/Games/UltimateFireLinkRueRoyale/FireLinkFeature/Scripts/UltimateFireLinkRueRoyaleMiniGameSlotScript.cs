...
public class UltimateFireLinkRueRoyaleMiniGameSlotScript : MonoBehaviour
{
    #region Variables

    // Slot Resource
    [HideInInspector] public UltimateFireLinkRueRoyaleMiniGameSlotType slotType;
    [HideInInspector] public UltimateFireLinkRueRoyaleMiniGameSlotResource currentResource;
    ...
    {
        var random = UltimateFireLinkRueRoyaleMiniGameSlotMachine.Instance.settings.slotResources[UnityEngine.Random.Range(0, UltimateFireLinkRueRoyaleMiniGameSlotMachine.Instance.settings.slotResources.Count)];
        SetType(random, false);
    }
    public void SetType(UltimateFireLinkRueRoyaleMiniGameSlotResource newType, bool finalResult)
    {
        ...
        if (slotType == UltimateFireLinkRueRoyaleMiniGameSlotType.Mini)
        {
            ...
            else
            {
                ...
                float bet = UltimateFireLinkRueRoyaleSlotMachine.Instance.CurrentBet();
    ...
    {
        var targetbox = UltimateFireLinkRueRoyaleMiniGameManager.Instance.Target_Text;
        ...
        UltimateFireLinkRueRoyaleMiniGameManager.Instance.Target_Text.text = $"${WinCollectedAmount.ToString("F2")}";
