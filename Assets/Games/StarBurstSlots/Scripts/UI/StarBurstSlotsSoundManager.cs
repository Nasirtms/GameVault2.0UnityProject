...
public class StarBurstSlotsSoundManager : MonoBehaviour
{
    public static StarBurstSlotsSoundManager Instance;

    [SerializeField] private StarBurstSlotsGameSettings soundData;
