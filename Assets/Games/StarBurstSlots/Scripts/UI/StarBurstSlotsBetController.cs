...
public class StarBurstSlotsBetController : MonoBehaviour
{
    #region Variables
    ...
    [SerializeField] private TMP_Text line_play;
    ...
    private void UpdateBetUI()
    {
        ...
        float linePlay = bet / 10f;

        betText.text = bet.ToString("0.00");
        line_play.text = linePlay.ToString("0.00");
    }
