...
public class FruitParadiseSoundManager : MonoBehaviour
{
    #region Variables

    public static FruitParadiseSoundManager Instance;

    [SerializeField] private FruitParadiseGameSettings soundData;
