...
public enum FruitParadiseSlotType
{
    Apple, Grapes, Watermelon, Lemon, Bonus, Wild, Bar, Scatter, Cherry, Orange
}

public enum FruitParadiseSpinType
{
    Single, All
}
...
[System.Serializable]
public struct FruitParadiseSlotResource
{
...
[System.Serializable]
public class FruitParadiseSpinSettings
{
    [Title("Reel Spinning")]
    [EnumToggleButtons] public FruitParadiseSpinType startSpin;
    [EnumToggleButtons] public FruitParadiseSpinType endSpin;
...
[System.Serializable]
public class FruitParadiseSoundItem
{
...
[CreateAssetMenu(menuName = "Settings/Fruit Paradise", fileName = "FruitParadise")]
public class FruitParadiseGameSettings : ScriptableObject
{
    public delegate void FruitParadiseSettingsEvents();
    public static event FruitParadiseSettingsEvents UpdateLayout;
    public static event FruitParadiseSettingsEvents UpdateScale;
    //public static event SettingsEvents OnSavePaylines;

    [TabGroup("Resources")]
    [TableList]
    //[SerializeField]
    public List<FruitParadiseSlotResource> resourcesList;

    [TabGroup("Sound")]
    [TableList]
    public List<FruitParadiseSoundItem> soundItems;
  
    [TabGroup("Spin Settings")]
    [HideLabel]
    public FruitParadiseSpinSettings spinSettings;
    ...
    public FruitParadiseSoundItem GetSound(string soundName)
    {
