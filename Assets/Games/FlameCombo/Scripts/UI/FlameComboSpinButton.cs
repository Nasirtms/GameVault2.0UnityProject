...
public class FlameComboSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        FlameComboUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        FlameComboUIManager.Instance.OnHoldSpin();
    }
