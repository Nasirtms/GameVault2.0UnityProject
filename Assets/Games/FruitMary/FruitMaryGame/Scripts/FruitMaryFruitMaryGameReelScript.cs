...
public class FruitMaryFruitMaryGameReelScript : MonoBehaviour
{
    [SerializeField] private VerticalLayoutGroup verticalLayout;
    public List<FruitMaryFruiMaryGameSlotScript> slots;
    ...
    private List<FruitMaryGameSlot> finalResultSymbols;
    ...
    public void Initialize(int index)
    {
        ...
        {
            slots = new List<FruitMaryFruiMaryGameSlotScript>(GetComponentsInChildren<FruitMaryFruiMaryGameSlotScript>());
        }


        for (var i = 0; i < this.slots.Count; i++)
        {
            slots[i].GetRandom(); // ? this = parent reel, reelIndex = column, i = row
        }

        _spinSettings = FruitMaryFruitMaryGameSlotMachine.Instance.settings.spinSettings;
    }
    ...
    public void ApplyFinalResult(int reelIndex)
    {
        ...
        var symbols = FruitMaryFruitMaryGameSlotMachine.Instance.spinSymbolMatrix[reelIndex];
        ...
        for (int rowIndex = 0; rowIndex < 1; rowIndex++)
        {
            ...
            var res = FruitMaryFruitMaryGameSlotMachine.GetResourceById(symbolData.id);
            int row = rowIndex;
