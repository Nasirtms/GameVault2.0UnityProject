...
public class DoubleJackpotBullseyeSoundManager : MonoBehaviour
{
    #region Variables
    public static DoubleJackpotBullseyeSoundManager Instance;

    [SerializeField] private DoubleJackpotBullseyeGameSettings soundData;
