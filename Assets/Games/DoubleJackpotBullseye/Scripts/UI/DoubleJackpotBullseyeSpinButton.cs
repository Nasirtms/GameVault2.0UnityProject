...
public class DoubleJackpotBullseyeSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        DoubleJackpotBullseyeUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        DoubleJackpotBullseyeUIManager.Instance.OnHoldSpin();
    }
