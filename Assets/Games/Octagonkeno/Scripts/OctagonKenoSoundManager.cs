...
public class OctagonKenoSoundManager : MonoBehaviour
{
    [SerializeField] private OctagonKenoGameSettings soundData;
    ...
    private static OctagonKenoSoundManager instance;
    public static OctagonKenoSoundManager Instance => instance;
    ...
    public void PlayMusic(string soundName)
    {
        ...
        if (soundData == null)
        {
            if (OctagonKeno.Instance == null)
            {
                return;
            }
            soundData = OctagonKeno.Instance.Settings;
        }
