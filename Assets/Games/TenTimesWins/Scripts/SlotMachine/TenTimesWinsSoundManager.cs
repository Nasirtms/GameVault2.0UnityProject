...
public class TenTimesWinsSoundManager : MonoBehaviour
{
    [SerializeField] private TenTimesWinsGameSettings soundData;
    ...
    private static TenTimesWinsSoundManager instance;
    public static TenTimesWinsSoundManager Instance => instance;
    ...
    public void PlayMusic(string soundName)
    {
        ...
        if (soundData == null)
        {
            soundData = TenTimesWinsSlotMachine.Instance.settings;
        }
