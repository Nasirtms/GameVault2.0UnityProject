...
[RequireComponent(typeof(WildXTrioBetController))]
[RequireComponent(typeof(WildXTrioRulesPopupController))]
[RequireComponent(typeof(WildXTrioAutoSpinController))]
public class WildXTrioUIManager : GameBetServices
{
    #region Variables

    public static WildXTrioUIManager Instance;
    ...
    // Scripts
    private WildXTrioBetController betController;
    private WildXTrioRulesPopupController rulesPopupController;
    private WildXTrioAutoSpinController autoSpinController;
    ...
    private void Start()
    {
        betController = GetComponent<WildXTrioBetController>();
        rulesPopupController = GetComponent<WildXTrioRulesPopupController>();
        autoSpinController = GetComponent<WildXTrioAutoSpinController>();
    ...
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsSoundMute())
            WildXTrioSoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!WildXTrioSoundManager.Instance.IsSoundMute())
            WildXTrioSoundManager.Instance.StopSFX();
    }
    public void PlayMusic(string soundName)
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsMusicMute())
            WildXTrioSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsMusicMute())
            WildXTrioSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsSoundMute())
            WildXTrioSoundManager.Instance.PlaySpinMusic(soundName);
    }
    public void StopSpinMusic(string soundName)
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsSoundMute())
            WildXTrioSoundManager.Instance.StopSpinMusic(soundName);
    }
    private void PlayWinMusic(string soundName)
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsSoundMute())
            WildXTrioSoundManager.Instance.PlayWinMusic(soundName);
    }
    ...
    private void StopWinMusic(string soundName)
    {
        if (soundName == null || WildXTrioSoundManager.Instance == null) return;
        if (!WildXTrioSoundManager.Instance.IsSoundMute())
            WildXTrioSoundManager.Instance.StopWinMusic(soundName);
    }
    public void SoundActive(bool soundActive)
    {
        WildXTrioSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        WildXTrioSoundManager.Instance.MuteMusic(!musicActive);
    ...
    {
        StopSpinMusic("Spin");
        WildXTrioSlotMachine.Instance.isStopBtnPressed = true;
        WildXTrioSlotMachine.Instance.StopWithResult();
