...
[RequireComponent(typeof(WildXReelBetController))]
[RequireComponent(typeof(WildXReelRulesPopupController))]
[RequireComponent(typeof(WildXReelAutoSpinController))]
public class WildXReelUIManager : GameBetServices
{
    #region Variables

    public static WildXReelUIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public WildXReelUIButtonController spinButton;
    [SerializeField] private WildXReelUIButtonController stopButton;
    [SerializeField] private WildXReelUIButtonController autoButton;
    [SerializeField] private WildXReelUIButtonController autoStopButton;
    ...
    // Scripts
    private WildXReelBetController betController;
    private WildXReelRulesPopupController rulesPopupController;
    private WildXReelAutoSpinController autoSpinController;
    ...
    private void Start()
    {
        betController = GetComponent<WildXReelBetController>();
        rulesPopupController = GetComponent<WildXReelRulesPopupController>();
        autoSpinController = GetComponent<WildXReelAutoSpinController>();
    ...
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsSoundMute())
            WildXReelSoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!WildXReelSoundManager.Instance.IsSoundMute())
            WildXReelSoundManager.Instance.StopSFX();
    }   
    public void PlayMusic(string soundName)
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsMusicMute())
            WildXReelSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsMusicMute())
            WildXReelSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsSoundMute())
            WildXReelSoundManager.Instance.PlaySpinMusic(soundName);
    }
    public void StopSpinMusic(string soundName)
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsSoundMute())
            WildXReelSoundManager.Instance.StopSpinMusic(soundName);
    }
    private void PlayWinMusic(string soundName)
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsSoundMute())
            WildXReelSoundManager.Instance.PlayWinMusic(soundName);
    }
    ...
    private void StopWinMusic(string soundName)
    {
        if (soundName == null || WildXReelSoundManager.Instance == null) return;
        if (!WildXReelSoundManager.Instance.IsSoundMute())
            WildXReelSoundManager.Instance.StopWinMusic(soundName);
    }
    public void SoundActive(bool soundActive)
    {
        WildXReelSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        WildXReelSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        ...
        StopSpinMusic("Spin");
        WildXReelSlotMachine.Instance.isStopBtnPressed = true;
        WildXReelSlotMachine.Instance.StopWithResult();
