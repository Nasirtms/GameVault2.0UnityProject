...
public class WheelOfFortuneSoundManager : MonoBehaviour
{
    #region Variables

    public static WheelOfFortuneSoundManager Instance;

    [SerializeField] private WheelOfFortuneGameSettings soundData;
