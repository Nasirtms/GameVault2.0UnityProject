...
public class WheelOfFortuneSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        WheelOfFortuneUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        WheelOfFortuneUIManager.Instance.OnHoldSpin();
    }
