...
public class PandaFortuneSoundManager : MonoBehaviour
{
    #region variables

    public static PandaFortuneSoundManager Instance;

    [SerializeField] private PandaFortuneGameSettings soundData;
