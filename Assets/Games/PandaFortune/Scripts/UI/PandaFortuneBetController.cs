...
public class PandaFortuneBetController : MonoBehaviour
{
    #region Variables
    ...
    public delegate void PandaFortuneBetControllerEvents();
    public static event PandaFortuneBetControllerEvents OnBetValueChanged;
