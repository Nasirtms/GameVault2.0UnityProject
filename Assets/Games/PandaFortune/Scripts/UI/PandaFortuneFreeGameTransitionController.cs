...
public class PandaFortuneFreeGameTransitionController : MonoBehaviour
{
    ...
    public IEnumerator StratFreeSpinTransition()
    {
        ...
        PandaFortuneUIManager.Instance.StopMusic("BG");
        ...
        PandaFortuneUIManager.Instance.PlayMusic("FreeSpinBG");
    }
    ...
    private IEnumerator EndFreeSpinTransition()
    {
        ...
        PandaFortuneUIManager.Instance.StopMusic("FreeSpinBG");
        ...
        PandaFortuneUIManager.Instance.PlayMusic("BG");
        yield return new WaitForSeconds(2.5f);
