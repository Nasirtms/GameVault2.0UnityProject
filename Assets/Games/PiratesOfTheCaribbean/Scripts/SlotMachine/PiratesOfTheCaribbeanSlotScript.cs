...
public class PiratesOfTheCaribbeanSlotScript : MonoBehaviour
{
    #region Variables

    // Slot Resource
    [HideInInspector] public PiratesOfTheCaribbeanSlotType slotType;
    [HideInInspector] public PiratesOfTheCaribbeanSlotResource currentResource;
    ...
    {
        var random = PiratesOfTheCaribbeanSlotMachine.Instance.settings.slotResources[UnityEngine.Random.Range(0, PiratesOfTheCaribbeanSlotMachine.Instance.settings.slotResources.Count)];
        SetType(random);
    }

    public void SetType(PiratesOfTheCaribbeanSlotResource newType)
    {
    ...
    //private bool isValidSlotForAnimation(PiratesOfTheCaribbeanSlotType slotType)
    //{
    //    switch (slotType)
    //    {
    //        case PiratesOfTheCaribbeanSlotType.Ten:
    //        case PiratesOfTheCaribbeanSlotType.Jack:
    //        case PiratesOfTheCaribbeanSlotType.Queen:
    //        case PiratesOfTheCaribbeanSlotType.King:
    //        case PiratesOfTheCaribbeanSlotType.Ace:
    //            return false;
    //        default:
    //            return true;
    //    }
