...
public class GoldenWheelBetController : MonoBehaviour
{
    #region Variables
    ...
    {
        GoldenWheelSlotMachine.Instance.isHighStake = true;
        isHighStake = true;
        UpdateBetUI();
    }
    ...
    {
        isHighStake = false;
        GoldenWheelSlotMachine.Instance.isHighStake = false;
        UpdateBetUI();
    }
    ...
    private void UpdateBetUI()
    {
        ...
        if(currentIndex == 0)
        {
            GoldenWheelUIManager.Instance.reel2NotSpinBg.SetActive(true);
            GoldenWheelUIManager.Instance.reel3NotSpinBg.SetActive(true);
            GoldenWheelSlotMachine.Instance.canReel2spin = false;
            GoldenWheelSlotMachine.Instance.canReel3spin = false;
        }
        else if (currentIndex == 1)
        {
            GoldenWheelUIManager.Instance.reel2NotSpinBg.SetActive(false);
            GoldenWheelUIManager.Instance.reel3NotSpinBg.SetActive(true);
            GoldenWheelSlotMachine.Instance.canReel2spin = true;
            GoldenWheelSlotMachine.Instance.canReel3spin = false;
        }
        else if (currentIndex == 2)
        {
            GoldenWheelUIManager.Instance.reel2NotSpinBg.SetActive(false);
            GoldenWheelUIManager.Instance.reel3NotSpinBg.SetActive(false);
            GoldenWheelSlotMachine.Instance.canReel2spin = true;
            GoldenWheelSlotMachine.Instance.canReel3spin = true;
        }
    }
