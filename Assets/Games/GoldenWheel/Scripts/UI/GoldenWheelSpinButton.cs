...
public class GoldenWheelSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        GoldenWheelUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        GoldenWheelUIManager.Instance.OnHoldSpin();
    }
