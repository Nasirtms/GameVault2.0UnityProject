...
public class GoldenWheelSoundManager : MonoBehaviour
{
    #region Variables
    public static GoldenWheelSoundManager Instance;

    [SerializeField] private GoldenWheelGameSettings soundData;
