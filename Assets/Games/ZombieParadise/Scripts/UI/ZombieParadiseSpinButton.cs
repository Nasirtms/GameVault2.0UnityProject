...
public class ZombieParadiseSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        ZombieParadiseUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        ZombieParadiseUIManager.Instance.OnHoldSpin();
    }
