...
public class MonkeyMadnessSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        MonkeyMadnessUIManager.Instance.OnClickSpin();
    }
    
    private void OnLongPress()
    {
        MonkeyMadnessUIManager.Instance.OnHoldSpin();
    }
