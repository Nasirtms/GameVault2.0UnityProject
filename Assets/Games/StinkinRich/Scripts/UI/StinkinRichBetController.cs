...
public class StinkinRichBetController : MonoBehaviour
{
    #region Variables
    ...
    public delegate void StinkinRichBetControllerEvents();
    public static event StinkinRichBetControllerEvents OnBetValueChanged;
    ...
    private void UpdateBetUI()
    {
        ...
        float lineBet = bet / 100f;
        totalPlayText.text = bet.ToString("0.00");
        linePlayText.text = lineBet.ToString("0.00");
    }
