...
public class StinkinRichSoundManager : MonoBehaviour
{
    #region variables

    public static StinkinRichSoundManager Instance;

    [SerializeField] private StinkinRichGameSettings soundData;
