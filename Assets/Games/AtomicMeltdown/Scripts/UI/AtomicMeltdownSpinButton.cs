...
public class AtomicMeltdownSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        AtomicMeltdownUIManager.Instance.OnClickSpin();
    }
    
    private void OnLongPress()
    {
        AtomicMeltdownUIManager.Instance.OnHoldSpin();
    }
