...
public class AtomicMeltdownSoundManager : MonoBehaviour
{
    #region Variables

    public static AtomicMeltdownSoundManager Instance;

    [SerializeField] private AtomicMeltdownGameSettings soundData;
