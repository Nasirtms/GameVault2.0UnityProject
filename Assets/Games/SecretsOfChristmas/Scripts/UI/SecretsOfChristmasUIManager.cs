...
[RequireComponent(typeof(SecretsOfChristmasBetController))]
[RequireComponent(typeof(SecretsOfChristmasAutoSpinController))]
[RequireComponent(typeof(SecretsOfChristmasRulesPopupController))]
public class SecretsOfChristmasUIManager : GameBetServices
{
    #region Variables

    public static SecretsOfChristmasUIManager Instance;
    ...
    [SerializeField] private WorldSpaceUIButton maxBetButton;
    ...
    private SecretsOfChristmasBetController betController;
    private SecretsOfChristmasAutoSpinController autoSpinController;
    private SecretsOfChristmasRulesPopupController rulesPopupController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<SecretsOfChristmasBetController>();
        autoSpinController = GetComponent<SecretsOfChristmasAutoSpinController>();
        rulesPopupController = GetComponent<SecretsOfChristmasRulesPopupController>();
    ...
    public void PlaySound(string soundName)
    {
        ...
        if (!SecretsOfChristmasSoundManager.Instance.IsSoundMute())
            SecretsOfChristmasSoundManager.Instance.PlaySFX(soundName);
    }

    public void StopCurrentSFX()
    {
        if (!SecretsOfChristmasSoundManager.Instance.IsSoundMute())
            SecretsOfChristmasSoundManager.Instance.StopSFX();
    }
    ...
    public void PlayMusic(string soundName)
    {
        ...
        if (!SecretsOfChristmasSoundManager.Instance.IsMusicMute())
            SecretsOfChristmasSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        ...
        if (!SecretsOfChristmasSoundManager.Instance.IsMusicMute())
            SecretsOfChristmasSoundManager.Instance.StopMusic(soundName);
    }
    ...
    public void PlaySpinMusic(string soundName)
    {
        ...
        if (!SecretsOfChristmasSoundManager.Instance.IsSoundMute())
            SecretsOfChristmasSoundManager.Instance.SpinPlayMusic(soundName);
    }
    ...
    public void StopSpinMusic(string soundName)
    {
        ...
        if (!SecretsOfChristmasSoundManager.Instance.IsSoundMute())
            SecretsOfChristmasSoundManager.Instance.SpinStopMusic(soundName);
    }

    private void SoundActive(bool soundActive)
    {
        SecretsOfChristmasSoundManager.Instance.MuteSFX(!soundActive);

        Image soundButtonImage = soundButton.transform.GetComponent<Image>();
        soundButtonImage.sprite = soundActive ? soundOnSprite : soundOffSprite;
    ...
    {
        SecretsOfChristmasSoundManager.Instance.MuteMusic(!musicActive);

        Image musicButtonImage = musicButton.transform.GetComponent<Image>();
        musicButtonImage.sprite = musicActive ? musicOnSprite : musicOffSprite;
    ...
    private void OnClickStop()
    {
        ...
        SecretsOfChristmasSlotMachine.Instance.isStopBtnPressed = true;
        SecretsOfChristmasSlotMachine.Instance.StopWithResult();

        if (SecretsOfChristmasAutoSpinController.isAutoSpinning)
        {
    ...
    public void UpdateButtons(string type)
    {
        ...
        maxBetButton.SetInteractable(interactable);
