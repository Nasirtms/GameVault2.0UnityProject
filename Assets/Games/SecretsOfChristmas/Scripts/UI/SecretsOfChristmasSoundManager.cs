...
public class SecretsOfChristmasSoundManager : MonoBehaviour
{
    #region variables

    public static SecretsOfChristmasSoundManager Instance;

    [SerializeField] private SecretsOfChristmasGameSettings soundData;
