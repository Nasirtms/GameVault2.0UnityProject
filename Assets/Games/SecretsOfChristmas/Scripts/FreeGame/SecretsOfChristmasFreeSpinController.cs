...
public class SecretsOfChristmasFreeSpinController : MonoBehaviour
{
    #region Variables
    ...
    private void EndFreeSpins()
    {
        ...
        SecretsOfChristmasSlotMachine.Instance.isFreeGame = false;

        //SecretsOfChristmasFreeGameTransitionController.Instance.EndFreeSpinTransition();
    }
