...
public enum ComeOnCashSlotType
{
    One, Zero, DoubleZero, Two, Five, Ten, Blank, TwoX, ThreeX, FiveX, Diamond, Bonus2Picks, Bonus3Picks, Bonus4Picks
}

public enum ComeOnCashSpinType
{
    Single, All
}
                                             
[System.Serializable]
public struct ComeOnCashSlotResource
{
    public ComeOnCashSlotType type;
    [PreviewField] public Sprite icon;
    [PreviewField] public Sprite paylineIcon;
}

[System.Serializable]
public class ComeOnCashSpinSettings
{
    [Title("Reel Spinning")]
    [EnumToggleButtons] public ComeOnCashSpinType startSpin;
    [EnumToggleButtons] public ComeOnCashSpinType endSpin;
...
[System.Serializable]
public class ComeOnCashSoundItem
{
...
[CreateAssetMenu(menuName = "Settings/Come On Cash", fileName = "Come On Cash")]
public class ComeOnCashGameSettings : ScriptableObject
{
    public delegate void ComeOnCashSettingsEvents();
    public static event ComeOnCashSettingsEvents UpdateLayout;
    public static event ComeOnCashSettingsEvents UpdateScale;

    [TabGroup("Resources")]
    [TableList]
    public List<ComeOnCashSlotResource> resourcesList;

    [TabGroup("Sound")]
    [TableList]
    public List<ComeOnCashSoundItem> soundItems;


    [TabGroup("Spin Settings")]
    [HideLabel]
    public ComeOnCashSpinSettings spinSettings;
    ...
    public ComeOnCashSoundItem GetSound(string soundName)
    {
