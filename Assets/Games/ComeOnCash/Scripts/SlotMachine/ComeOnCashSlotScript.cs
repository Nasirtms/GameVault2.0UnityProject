...
public class ComeOnCashSlotScript : MonoBehaviour
{
    #region Variables
    ...
    // Slot Details
    private int index;
    [HideInInspector] public ComeOnCashSlotType type;
    public ComeOnCashSlotResource currentResource;
    [HideInInspector] public bool isResultSet = false;

    // Components
    private Image icon;
    private Image paylineIcon;
    private ComeOnCashReelScript _parent;
    ...
    public void Initialize(ComeOnCashReelScript parentReel, int index)
    {
        this.index = index;
    ...
    public void SetType(ComeOnCashSlotResource newType)
    {
    ...
    {
        var random = ComeOnCashSlotMachine.CachedRealSymbols[
            Random.Range(0, ComeOnCashSlotMachine.CachedRealSymbols.Count)];
        SetType(random);
    }
    ...
    {
        if(type == ComeOnCashSlotType.Blank || type == ComeOnCashSlotType.Diamond)
        {
            return;
        }
