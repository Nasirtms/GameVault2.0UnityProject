...
public class ComeOnCashSpinButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    #region Variables
    ...
    {
        ComeOnCashUIManager.Instance.OnClickSpin();
    }

    private void OnLongPress()
    {
        ComeOnCashUIManager.Instance.OnHoldSpin();
    }
