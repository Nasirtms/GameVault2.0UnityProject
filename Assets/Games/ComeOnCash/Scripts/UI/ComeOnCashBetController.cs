...
public class ComeOnCashBetController : MonoBehaviour
{
    #region Variables
    ...
    {
        ComeOnCashSlotMachine.Instance.isHighStake = true;
        isHighStake = true;
        UpdateBetUI();
    }
    ...
    {
        isHighStake = false;
        ComeOnCashSlotMachine.Instance.isHighStake = false;
        UpdateBetUI();
    }
    ...
    private void UpdateBetUI()
    {
        ...
        if(currentIndex == 0)
        {
            ComeOnCashUIManager.Instance.reel2NotSpinBg.SetActive(true);
            ComeOnCashUIManager.Instance.reel3NotSpinBg.SetActive(true);
            ComeOnCashUIManager.Instance.reel1LockedBg.SetActive(false);
            ComeOnCashSlotMachine.Instance.canReel1spin = true;
            ComeOnCashSlotMachine.Instance.canReel2spin = false;
            ComeOnCashSlotMachine.Instance.canReel3spin = false;
        }
        else if (currentIndex == 1)
        {
            ComeOnCashUIManager.Instance.reel2NotSpinBg.SetActive(false);
            ComeOnCashUIManager.Instance.reel3NotSpinBg.SetActive(true);
            ComeOnCashUIManager.Instance.reel1LockedBg.SetActive(false);
            ComeOnCashSlotMachine.Instance.canReel1spin = true;
            ComeOnCashSlotMachine.Instance.canReel2spin = true;
            ComeOnCashSlotMachine.Instance.canReel3spin = false;
        }
        else if (currentIndex == 2)
        {
            ComeOnCashUIManager.Instance.reel2NotSpinBg.SetActive(false);
            ComeOnCashUIManager.Instance.reel3NotSpinBg.SetActive(false);
            ComeOnCashUIManager.Instance.reel1LockedBg.SetActive(false);
            ComeOnCashSlotMachine.Instance.canReel1spin = true;
            ComeOnCashSlotMachine.Instance.canReel2spin = true;
            ComeOnCashSlotMachine.Instance.canReel3spin = true;
        }
    }
