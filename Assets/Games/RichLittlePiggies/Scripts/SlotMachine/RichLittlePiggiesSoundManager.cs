...
public class RichLittlePiggiesSoundManager : MonoBehaviour
{
    [SerializeField] private RichLittlePiggiesGameSettings soundData;
    ...
    private static RichLittlePiggiesSoundManager instance;
    public static RichLittlePiggiesSoundManager Instance => instance;
