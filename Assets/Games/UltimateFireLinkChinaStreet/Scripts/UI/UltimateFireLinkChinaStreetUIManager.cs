...
[RequireComponent(typeof(UltimateFireLinkChinaStreetBetController))]
[RequireComponent(typeof(UltimateFireLinkChinaStreetRulesPopupController))]
[RequireComponent(typeof(UltimateFireLinkChinaStreetAutoSpinController))]
public class UltimateFireLinkChinaStreetUIManager : GameBetServices
{
    #region Variables

    public static UltimateFireLinkChinaStreetUIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public UltimateFireLinkChinaStreetUIButtonController spinButton;
    [SerializeField] public UltimateFireLinkChinaStreetUIButtonController stopButton;
    [SerializeField] public UltimateFireLinkChinaStreetUIButtonController autoButton;
    [SerializeField] public UltimateFireLinkChinaStreetUIButtonController autoStopButton;
    ...
    private UltimateFireLinkChinaStreetBetController betController;
    private UltimateFireLinkChinaStreetRulesPopupController rulesPopupController;
    private UltimateFireLinkChinaStreetAutoSpinController autoSpinController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<UltimateFireLinkChinaStreetBetController>();
        rulesPopupController = GetComponent<UltimateFireLinkChinaStreetRulesPopupController>();
        autoSpinController = GetComponent<UltimateFireLinkChinaStreetAutoSpinController>();
    ...
    public void PlaySound(string soundName)
    {
        ...
        if (!UltimateFireLinkChinaStreetSoundManager.Instance.IsSoundMute())
            UltimateFireLinkChinaStreetSoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!UltimateFireLinkChinaStreetSoundManager.Instance.IsSoundMute())
            UltimateFireLinkChinaStreetSoundManager.Instance.StopSFX();
    }
    public void PlayMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkChinaStreetSoundManager.Instance.IsMusicMute())
            UltimateFireLinkChinaStreetSoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkChinaStreetSoundManager.Instance.IsMusicMute())
            UltimateFireLinkChinaStreetSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkChinaStreetSoundManager.Instance.IsSoundMute())
            UltimateFireLinkChinaStreetSoundManager.Instance.SpinPlayMusic(soundName);
    }
    ...
    public void StopSpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkChinaStreetSoundManager.Instance.IsSoundMute())
            UltimateFireLinkChinaStreetSoundManager.Instance.SpinStopMusic(soundName);
    }
    ...
    {
        UltimateFireLinkChinaStreetSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        UltimateFireLinkChinaStreetSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        PlaySound("Button");
        StopSpinMusic("Spin");
        UltimateFireLinkChinaStreetSlotMachine.Instance.isStopBtnPressed = true;
        UltimateFireLinkChinaStreetSlotMachine.Instance.StopWithResult();
    }

    private void OnClickAuto()
    {
        if (autoSpinController == null) return;
        autoButton.setInteractable(!UltimateFireLinkChinaStreetSlotMachine.Instance.InSpin);
    ...
    private void OnClickAutoStop()
    {
        ...
        if (!UltimateFireLinkChinaStreetSlotMachine.Instance.InSpin)
        {
            UpdateButtons("Idle");
        }
    }
