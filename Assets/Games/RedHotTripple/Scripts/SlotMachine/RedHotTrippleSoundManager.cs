...
public class RedHotTrippleSoundManager : MonoBehaviour
{
    #region Variables

    public static RedHotTrippleSoundManager Instance;

    [SerializeField] private RedHotTrippleGameSettings soundData;
