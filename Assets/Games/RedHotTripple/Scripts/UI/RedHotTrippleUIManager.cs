...
[RequireComponent(typeof(RedHotTrippleBetController))]
[RequireComponent(typeof(RedHotTrippleRulesPopupController))]
[RequireComponent(typeof(RedHotTrippleAutoSpinController))]
public class RedHotTrippleUIManager : GameBetServices
{
    #region Variables

    public static RedHotTrippleUIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] private RedHotTrippleUIButtonController spinButton;
    [SerializeField] private RedHotTrippleUIButtonController stopButton;
    [SerializeField] private RedHotTrippleUIButtonController autoButton;
    [SerializeField] private RedHotTrippleUIButtonController autoStopButton;
    ...
    // Scripts
    private RedHotTrippleBetController betController;
    private RedHotTrippleRulesPopupController rulesPopupController;
    private RedHotTrippleAutoSpinController autoSpinController;
    ...
    {
        winAmount.text = "0.00";
        betController = GetComponent<RedHotTrippleBetController>();
        rulesPopupController = GetComponent<RedHotTrippleRulesPopupController>();
        autoSpinController = GetComponent<RedHotTrippleAutoSpinController>();
    ...
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsSoundMute())
            RedHotTrippleSoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!RedHotTrippleSoundManager.Instance.IsSoundMute())
            RedHotTrippleSoundManager.Instance.StopSFX();
    }
    public void PlayMusic(string soundName)
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsMusicMute())
            RedHotTrippleSoundManager.Instance.PlayMusic(soundName);
    }
    public void StopMusic(string soundName)
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsMusicMute())
            RedHotTrippleSoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsSoundMute())
            RedHotTrippleSoundManager.Instance.PlaySpinMusic(soundName);
    }
    public void StopSpinMusic(string soundName)
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsSoundMute())
            RedHotTrippleSoundManager.Instance.StopSpinMusic(soundName);
    }
    private void PlayWinMusic(string soundName)
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsSoundMute())
            RedHotTrippleSoundManager.Instance.PlayWinMusic(soundName);
    }
    ...
    private void StopWinMusic(string soundName)
    {
        if (soundName == null || RedHotTrippleSoundManager.Instance == null) return;
        if (!RedHotTrippleSoundManager.Instance.IsSoundMute())
            RedHotTrippleSoundManager.Instance.StopWinMusic(soundName);
    }
    public void SoundActive(bool soundActive)
    {
        RedHotTrippleSoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        RedHotTrippleSoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        PlaySound("Button");
        StopSpinMusic("Spin");
        RedHotTrippleSlotMachine.Instance.isStopBtnPressed = true;
        RedHotTrippleSlotMachine.Instance.StopWithResult();
        if (RedHotTrippleAutoSpinController.isAutoSpinning)
        {
    ...
    private void PlayTextAnimation(float winAmount)
    {
        ...
        textAnimationCoroutine = StartCoroutine(PlayTextAnimationWithDelay(winAmount, textAnimationDelay));
        //textAnimationCoroutine = StartCoroutine(AnimateToValue(winAmount, 1f, this.winAmount));
    }

    private IEnumerator PlayTextAnimationWithDelay(float winAmount, float delay)
    {
        yield return new WaitForSeconds(delay);
        yield return StartCoroutine(AnimateToValue(winAmount, 1f, this.winAmount));
    }
