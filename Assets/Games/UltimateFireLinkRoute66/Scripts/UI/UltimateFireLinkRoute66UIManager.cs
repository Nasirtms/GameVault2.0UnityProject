...
[RequireComponent(typeof(UltimateFireLinkRoute66BetController))]
[RequireComponent(typeof(UltimateFireLinkRoute66RulesPopupController))]
[RequireComponent(typeof(UltimateFireLinkRoute66AutoSpinController))]
public class UltimateFireLinkRoute66UIManager : GameBetServices
{
    #region Variables

    public static UltimateFireLinkRoute66UIManager Instance;
    ...
    [Header("Spin Buttons")]
    [SerializeField] public UltimateFireLinkRoute66UIButtonController spinButton;
    [SerializeField] public UltimateFireLinkRoute66UIButtonController stopButton;
    [SerializeField] public UltimateFireLinkRoute66UIButtonController autoButton;
    [SerializeField] public UltimateFireLinkRoute66UIButtonController autoStopButton;
    ...
    private UltimateFireLinkRoute66BetController betController;
    private UltimateFireLinkRoute66RulesPopupController rulesPopupController;
    private UltimateFireLinkRoute66AutoSpinController autoSpinController;
    ...
    private void Start()
    {
        ...
        betController = GetComponent<UltimateFireLinkRoute66BetController>();
        rulesPopupController = GetComponent<UltimateFireLinkRoute66RulesPopupController>();
        autoSpinController = GetComponent<UltimateFireLinkRoute66AutoSpinController>();
    ...
    public void PlaySound(string soundName)
    {
        ...
        if (!UltimateFireLinkRoute66SoundManager.Instance.IsSoundMute())
            UltimateFireLinkRoute66SoundManager.Instance.PlaySFX(soundName);
    }
    public void StopCurrentSFX()
    {
        if (!UltimateFireLinkRoute66SoundManager.Instance.IsSoundMute())
            UltimateFireLinkRoute66SoundManager.Instance.StopSFX();
    }
    public void PlayMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRoute66SoundManager.Instance.IsMusicMute())
            UltimateFireLinkRoute66SoundManager.Instance.PlayMusic(soundName);
    }
    ...
    public void StopMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRoute66SoundManager.Instance.IsMusicMute())
            UltimateFireLinkRoute66SoundManager.Instance.StopMusic(soundName);
    }
    public void PlaySpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRoute66SoundManager.Instance.IsSoundMute())
            UltimateFireLinkRoute66SoundManager.Instance.SpinPlayMusic(soundName);
    }
    ...
    public void StopSpinMusic(string soundName)
    {
        if (string.IsNullOrEmpty(soundName)) return;
        if (!UltimateFireLinkRoute66SoundManager.Instance.IsSoundMute())
            UltimateFireLinkRoute66SoundManager.Instance.SpinStopMusic(soundName);
    }
    ...
    {
        UltimateFireLinkRoute66SoundManager.Instance.MuteSFX(!soundActive);
    ...
    {
        UltimateFireLinkRoute66SoundManager.Instance.MuteMusic(!musicActive);
    ...
    private void OnClickStop()
    {
        PlaySound("Button");
        StopSpinMusic("Spin");
        UltimateFireLinkRoute66SlotMachine.Instance.isStopBtnPressed = true;
        UltimateFireLinkRoute66SlotMachine.Instance.StopWithResult();
    }

    private void OnClickAuto()
    {
        if (autoSpinController == null) return;
        autoButton.setInteractable(!UltimateFireLinkRoute66SlotMachine.Instance.InSpin);
    ...
    private void OnClickAutoStop()
    {
        ...
        if (!UltimateFireLinkRoute66SlotMachine.Instance.InSpin)
        {
            UpdateButtons("Idle");
        }
    }
