...
public class UltimateFireLinkRoute66SoundManager : MonoBehaviour
{
    #region variables

    public static UltimateFireLinkRoute66SoundManager Instance;

    [SerializeField] private UltimateFireLinkRoute66GameSettings soundData;
