...
public class UltimateFireLinkRoute66MiniGameSlotMachine : MonoBehaviour
{
    #region Variables
    public static UltimateFireLinkRoute66MiniGameSlotMachine Instance;

    [Header("Machine References")]
    public UltimateFireLinkRoute66MiniGameSettings settings;
    public List<UltimateFireLinkRoute66MiniGameReelScript> reels;
    ...
    public IEnumerator StartSpin()
    {
        ...
        if (!UltimateFireLinkRoute66SlotMachine.Instance.isMiniGame || firstReSpin)
        {
            UltimateFireLinkRoute66SlotMachine.Instance.isMiniGameReady = false;
        }
    ...
    private IEnumerator WaitUntilResultAndThenStop()
    {
        ...
        if (currentSpinResult == null || currentSpinResult.reels == null || currentSpinResult.reels.Count == 0)
        {
            ...
            UltimateFireLinkRoute66UIManager.Instance.UpdateButtons("Stop");
    ...
    public void Stop()
    {
        ...
        if (currentSpinResult == null || currentSpinResult.reels == null || currentSpinResult.reels.Count == 0)
        {
            ...
            if (!UltimateFireLinkRoute66SlotMachine.Instance.isMiniGame)
            {
                UltimateFireLinkRoute66UIManager.Instance.UpdateButtons("Stop");
            }
            return;
    ...
    private IEnumerator StopReelsWithResultRoutine()
    {
        ...
        if (settings.spinSettings.endSpin == UltimateFireLinkRoute66MiniGameSpinMode.SpinAll)
        {
    ...
    //    }
    //}
    private void SetReelDirection(UltimateFireLinkRoute66MiniGameReelScript reel)
    {
        UltimateFireLinkRoute66MiniGameSpinDirection direction = settings.spinSettings.spinDirection;

        // If random direction, choose randomly for each reel
        if (direction == UltimateFireLinkRoute66MiniGameSpinDirection.Random)
        {
            direction = Random.value > 0.5f ? UltimateFireLinkRoute66MiniGameSpinDirection.Up : UltimateFireLinkRoute66MiniGameSpinDirection.Down;
        }
    ...
    //    }
    //}
    public static UltimateFireLinkRoute66MiniGameSlotResource? GetResourceById(string id)
    {
    ...
    public bool isSphereSlot(UltimateFireLinkRoute66MiniGameSlotType slotType)
    {
        if (slotType == UltimateFireLinkRoute66MiniGameSlotType.Mini)
        {
            return true;
        }
