...
public class UltimateFireLinkRoute66MiniGameSlotScript : MonoBehaviour
{
    #region Variables

    // Slot Resource
    [HideInInspector] public UltimateFireLinkRoute66MiniGameSlotType slotType;
    [HideInInspector] public UltimateFireLinkRoute66MiniGameSlotResource currentResource;
    ...
    {
        var random = UltimateFireLinkRoute66MiniGameSlotMachine.Instance.settings.slotResources[UnityEngine.Random.Range(0, UltimateFireLinkRoute66MiniGameSlotMachine.Instance.settings.slotResources.Count)];
        SetType(random, false);
    }
    public void SetType(UltimateFireLinkRoute66MiniGameSlotResource newType, bool finalResult)
    {
        ...
        if (slotType == UltimateFireLinkRoute66MiniGameSlotType.Mini)
        {
            ...
            else
            {
                ...
                float bet = UltimateFireLinkRoute66SlotMachine.Instance.CurrentBet();
    ...
    {
        var targetbox = UltimateFireLinkRoute66MiniGameManager.Instance.Target_Text;
        ...
        UltimateFireLinkRoute66MiniGameManager.Instance.Target_Text.text = $"${WinCollectedAmount.ToString("F2")}";
