...
public class KenoSoundManager : MonoBehaviour
{
    [SerializeField] private SuperBallGameSettings soundData;
    ...
    private static KenoSoundManager instance;
    public static KenoSoundManager Instance => instance;
