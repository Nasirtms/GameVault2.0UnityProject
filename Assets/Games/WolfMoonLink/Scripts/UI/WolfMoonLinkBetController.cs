...
public class WolfMoonLinkBetController : MonoBehaviour
{
    #region Variables
    ...
    private float[] betValues = new float[] {
        0.10f, 0.50f, 1.00f, 2.00f, 3.00f, 5.00f, 10.00f, 15.00f, 20.00f
    };
    ...
    private void UpdateBetUI()
    {
        ...
        float amount = bet * 1000;
        jackpotText.text = amount.ToString("0.00");
    }
    #endregion
}