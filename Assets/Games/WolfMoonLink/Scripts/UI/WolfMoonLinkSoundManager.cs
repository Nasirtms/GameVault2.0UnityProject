...
public class WolfMoonLinkSoundManager : MonoBehaviour
{
    #region Variables

    public static WolfMoonLinkSoundManager Instance;

    [SerializeField] private WolfMoonLinkGameSettings soundData;
