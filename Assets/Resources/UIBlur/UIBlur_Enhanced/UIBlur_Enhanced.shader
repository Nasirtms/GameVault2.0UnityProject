Shader "Custom/UIBlur_Enhanced"
{
    Properties
    {
        ...
        _Radius("Blur Radius", Range(0, 64)) = 8
        _OverlayColor("Blurred Overlay/Opacity", Color) = (0.5, 0.5, 0.5, 1)

        [Header(Blur Options)]
        [Enum(Box,0,Gaussian,1,SoftGaussian,2,Tent,3)] _BlurAlgorithm("Blur Algorithm", Float) = 1
        _SampleStep("Sample Step", Range(0.5, 4)) = 1
        _Softness("Softness / Falloff", Range(0.25, 4)) = 1
        _CenterWeight("Center Weight", Range(0.5, 4)) = 1
    ...
    Category
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                #include "UIBlur_Shared_Enhanced.cginc"
